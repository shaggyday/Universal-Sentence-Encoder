...
# v2.x: treats each reviews as an individual sentence 
# 		--> treats each sentence as individual sentences
...
np.random.seed(10)
# Get the data ready
dataset = pd.read_csv('movie_reviews_sentence_level.csv.bz2', compression='bz2')
